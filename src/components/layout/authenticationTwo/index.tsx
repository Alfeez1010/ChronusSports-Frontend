  ...
  return (
    <>
      <div className="fixed inset-0 flex h-screen bg-[#0D102D]">
        <div
          className={`${styles.col1}  relative hidden max-w-[50%] flex-1 lg:flex flex items-center justify-center flex content-between flex-col justify-between min-h-screen max-h-full
        `}
        >
