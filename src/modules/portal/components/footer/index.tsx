...
const FooterClub = () => {
  return (
    <>
      <footer
        className={`${styles.footer} bg-[#0D102D]`}
      ...
      >
        ...
        <div
          className={`${styles.container} mx-auto px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-16 flex flex-col`}
        >
          <div className="flex xl:grid-cols-3 xl:gap-8 sm:justify-between flex-wrap">
            <div className="space-y-8 max-w-[369px]">
              <Image
                ...
                alt="Company name"
              />
              <p className="not-italic font-normal text-base leading-[150%] text-[15px] text-[#A1A2B3]">
                CHRONUS Sports é a sua chance de possuir, vender e negociar
                NFT’s colecionáveis digitais oficiais dos melhores atletas
                    ...
                    {navigation.browser.map((item) => (
                      <li key={item.name}>
                        <a
                          ...
                          className={
                            item.href != '#'
                              ? 'not-italic font-normal  font-[400] text-[14px]  leading-[150%] flex items-center text-[#A1A2B3]'
                              : 'not-italic font-normal  font-[400] text-[14px]  leading-[150%] flex items-center text-[#333950] pointer-events-none'
                          }
                        >
                          {item.name}
                        </a>
                  ...
                  <ul role="list" className="mt-6 space-y-4">
                    {navigation.institutional.map((item) => (
                      <li key={item.name}>
                        <a
                          href={item.href}
                          className="not-italic  font-[400] text-[14px] leading-[150%] flex items-center text-[#A1A2B3]"
                        >
                          {item.name}
                        </a>
                      </li>
          ...
          <div className="mt-16  pt-8 sm:mt-20 lg:mt-24 flex sm:justify-between flex-wrap justify-center">
            <p className="text-[13px] leading-5 text-gray-400">
              ...
              <span className="text-[#00e4ff]">Mooh!Tech</span>
            </p>
            <p className="flex text-xs leading-5 text-gray-400 gap-5">
              <Link
                target="_blank"
                href="https://www.moohtech.com/chronus/sports/termsofuse/pt-BR/termsofuse_CHRONUS_Sports_PT-br.pdf"
                className="pr-4 py-0 hover:text-[#00e4ff] font-[400] text-[12px]"
              >
                Termos e Condições
              </Link>
              <Link
                target="_blank"
                href="https://www.moohtech.com/chronus/sports/privacypolicy/pt-BR/privacypolicy_CHRONUS_Sports_pt-BR.pdf"
                className="py-0 hover:text-[#00e4ff] font-[400] text-[12px]"
              >
